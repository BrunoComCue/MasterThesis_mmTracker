...
parser.add_argument('--name', type=str, default='vel_det_results')
parser.add_argument('--det_folder', type=str, default='/media/bruno/toshibaHDD/data_folder/detection')
parser.add_argument('--pred_file', type=str, default='/media/bruno/toshibaHDD/prediction.pkl')
parser.add_argument('--info_file', type=str, default='/media/bruno/toshibaHDD/infos.pkl')
parser.add_argument('--data_folder', type=str, default='/media/bruno/toshibaHDD/data_folder/pc')
parser.add_argument('--metadata', action='store_true', default=True)
parser.add_argument('--id', action='store_true', default=True)
...
def main(data_folder, pred_file, info_file):
    raw_folder = os.path.join(data_folder, 'raw_pc')
...
if __name__ == '__main__':
    ...
    result_path = os.path.join(det_folder, 'pkl_validation.bin')
